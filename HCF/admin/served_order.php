...
<body>
    <div class="full-screen">
        ...
        // Fetch served orders with total price from the order_table
        $served_order_query = "SELECT so.served_order_id, so.order_id, c.customer_name, p.product_name, o.quantity, o.total_price
                            FROM served_order so
        ...
        if ($served_order_result->num_rows > 0) {
            // Display served orders
            echo "<table class='table table-bordered table-striped'>";
            echo "<thead class='thead-dark'>";
            echo "<tr>";
            echo "<th>Served Order ID</th><th>Order ID</th><th>Customer Name</th><th>Product Name</th><th>Quantity</th><th>Total Price</th>";
            echo "</tr>";
            echo "</thead>";
            echo "<tbody>";

            // Fetch and display each served order row
