        ...
        <div class="content">
            ...
            <form method="post" action="update_category.php">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="categoryName" name="category_name" value="<?php echo $row["category_name"]; ?>">
                </div>
                <div class="form-group">
                    <label for="categoryDescription">Description:</label>
                    <input type="text" class="form-control" id="categoryDescription" name="category_description" value="<?php echo $row["category_description"]; ?>">
                </div>
