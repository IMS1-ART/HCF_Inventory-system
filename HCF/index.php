...
<!-- component -->
<div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 h-[calc(100vh)] w-full max-w-[18rem] p-4 shadow-xl shadow-blue-gray-900/5">
  <div class="mb-2 p-4">
...
<div class="w-full pt-5 px-4 mb-8 mx-auto ">
   ...
   <h2> Welcome to the Admin Dashboard
      <br>
This is where you manage your inventory and other administrative tasks.</h2></div>
</div></body>
</html>